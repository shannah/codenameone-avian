...
public class AwtGraphicsConfigData extends XWrapperBase { 
	...
	public static int getSize() { return ((XlibWrapper.dataModel == 32)?(128):(208)); }
	...
	public int get_isTranslucencySupported() { log.finest("");return (Native.getInt(pData+((XlibWrapper.dataModel == 32)?(92):(160)))); }
	public void set_isTranslucencySupported(int v) { log.finest(""); Native.putInt(pData+((XlibWrapper.dataModel == 32)?(92):(160)), v); }
	public XRenderPictFormat get_renderPictFormat() { log.finest("");return new XRenderPictFormat(pData + ((XlibWrapper.dataModel == 32)?(96):(168))); }
