...
public  class NSLevelIndicatorCell extends com.apple.jobjc.appkit.NSActionCell {
	public NSLevelIndicatorCell(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSLevelIndicatorCell(final NSLevelIndicatorCell obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
	...
	private static com.apple.jobjc.Invoke.MsgSend initWithLevelIndicatorStyle_IMetInst;
	 final private com.apple.jobjc.Invoke.MsgSend get_initWithLevelIndicatorStyle_IMetInst(){
		return ((initWithLevelIndicatorStyle_IMetInst != null)
	? (initWithLevelIndicatorStyle_IMetInst)
	: (initWithLevelIndicatorStyle_IMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "initWithLevelIndicatorStyle:", com.apple.jobjc.Coder.IDCoder.INST, com.apple.jobjc.MixedPrimitiveCoder.UIntULongLongCoder)));
	}

	 public <T extends com.apple.jobjc.ID> T initWithLevelIndicatorStyle(final long levelIndicatorStyle){
			final com.apple.jobjc.Invoke.MsgSend initWithLevelIndicatorStyle_IMetInst = get_initWithLevelIndicatorStyle_IMetInst();

		final com.apple.jobjc.NativeArgumentBuffer nativeBuffer = getRuntime().getThreadLocalState();
		initWithLevelIndicatorStyle_IMetInst.init(nativeBuffer, this);
		com.apple.jobjc.MixedPrimitiveCoder.UIntULongLongCoder.push(nativeBuffer, levelIndicatorStyle);
		initWithLevelIndicatorStyle_IMetInst.invoke(nativeBuffer);
		final com.apple.jobjc.ID returnValue = (com.apple.jobjc.ID) (com.apple.jobjc.Coder.IDCoder.INST.pop(nativeBuffer));
		return (T)returnValue;
	}

	private static com.apple.jobjc.Invoke.MsgSend levelIndicatorStyle_IMetInst;
	 final private com.apple.jobjc.Invoke.MsgSend get_levelIndicatorStyle_IMetInst(){
		return ((levelIndicatorStyle_IMetInst != null)
	? (levelIndicatorStyle_IMetInst)
	: (levelIndicatorStyle_IMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "levelIndicatorStyle", com.apple.jobjc.MixedPrimitiveCoder.UIntULongLongCoder)));
	}

	 public long levelIndicatorStyle(){
			final com.apple.jobjc.Invoke.MsgSend levelIndicatorStyle_IMetInst = get_levelIndicatorStyle_IMetInst();

		final com.apple.jobjc.NativeArgumentBuffer nativeBuffer = getRuntime().getThreadLocalState();
		levelIndicatorStyle_IMetInst.init(nativeBuffer, this);
		levelIndicatorStyle_IMetInst.invoke(nativeBuffer);
	...
	private static com.apple.jobjc.Invoke.MsgSend setLevelIndicatorStyle_IMetInst;
	 final private com.apple.jobjc.Invoke.MsgSend get_setLevelIndicatorStyle_IMetInst(){
		return ((setLevelIndicatorStyle_IMetInst != null)
	? (setLevelIndicatorStyle_IMetInst)
	: (setLevelIndicatorStyle_IMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "setLevelIndicatorStyle:", com.apple.jobjc.Coder.VoidCoder.INST, com.apple.jobjc.MixedPrimitiveCoder.UIntULongLongCoder)));
	}

	 public void setLevelIndicatorStyle(final long levelIndicatorStyle){
			final com.apple.jobjc.Invoke.MsgSend setLevelIndicatorStyle_IMetInst = get_setLevelIndicatorStyle_IMetInst();

		final com.apple.jobjc.NativeArgumentBuffer nativeBuffer = getRuntime().getThreadLocalState();
		setLevelIndicatorStyle_IMetInst.init(nativeBuffer, this);
		com.apple.jobjc.MixedPrimitiveCoder.UIntULongLongCoder.push(nativeBuffer, levelIndicatorStyle);
		setLevelIndicatorStyle_IMetInst.invoke(nativeBuffer);
