...
public  class NSCloneCommand extends com.apple.jobjc.foundation.NSScriptCommand {
	public NSCloneCommand(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSCloneCommand(final NSCloneCommand obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
