...
public final class CFMachPortContext extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		com.apple.jobjc.Coder.UnknownCoder.INST,
		com.apple.jobjc.Coder.UnknownCoder.INST){
		@Override protected CFMachPortContext newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new CFMachPortContext(runtime); }
	};

	CFMachPortContext(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public CFMachPortContext(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
