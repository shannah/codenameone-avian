...
public  class NSNibOutletConnector extends com.apple.jobjc.appkit.NSNibConnector {
	public NSNibOutletConnector(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSNibOutletConnector(final NSNibOutletConnector obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
