...
public final class NSSwappedFloat extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		@Override protected NSSwappedFloat newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new NSSwappedFloat(runtime); }
	};

	NSSwappedFloat(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public NSSwappedFloat(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
