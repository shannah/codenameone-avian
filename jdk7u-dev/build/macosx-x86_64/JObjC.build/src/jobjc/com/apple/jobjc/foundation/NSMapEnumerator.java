...
public final class NSMapEnumerator extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		@Override protected NSMapEnumerator newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new NSMapEnumerator(runtime); }
	};

	NSMapEnumerator(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public NSMapEnumerator(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
