...
public final class CFRunLoopSourceContext1 extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		com.apple.jobjc.Coder.UnknownCoder.INST,
		com.apple.jobjc.Coder.UnknownCoder.INST){
		@Override protected CFRunLoopSourceContext1 newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new CFRunLoopSourceContext1(runtime); }
	};

	CFRunLoopSourceContext1(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public CFRunLoopSourceContext1(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
...
return returnValue;
	...
	private static final int GETPORT_OFFSET = com.apple.jobjc.JObjCRuntime.IS64 ? 56 : 28;
	//class com.apple.internal.jobjc.generator.model.coders.CoderDescriptor$UnknownCoderDescriptor
	public Object /* CFWriteStreamClientCallBack (^?, ^?) */ getPort(){
final Object /* CFWriteStreamClientCallBack (^?, ^?) */ returnValue = (Object /* CFWriteStreamClientCallBack (^?, ^?) */) (com.apple.jobjc.Coder.UnknownCoder.INST.pop(getRuntime(), this.raw.bufferPtr + GETPORT_OFFSET));
return returnValue;
	}

	public void setGetPort(final Object /* CFWriteStreamClientCallBack (^?, ^?) */ getPort__){
		com.apple.jobjc.Coder.UnknownCoder.INST.push(getRuntime(), this.raw.bufferPtr + GETPORT_OFFSET, getPort__);
	}

	private static final int PERFORM_OFFSET = com.apple.jobjc.JObjCRuntime.IS64 ? 64 : 32;
	//class com.apple.internal.jobjc.generator.model.coders.CoderDescriptor$UnknownCoderDescriptor
