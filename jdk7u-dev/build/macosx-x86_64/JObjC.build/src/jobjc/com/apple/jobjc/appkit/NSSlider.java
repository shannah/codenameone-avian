...
public  class NSSlider extends com.apple.jobjc.appkit.NSControl {
	public NSSlider(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSSlider(final NSSlider obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
	...
	: (setImage_IMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "setImage:", com.apple.jobjc.Coder.VoidCoder.INST, com.apple.jobjc.Coder.IDCoder.INST)));
	 ...
	 public void setImage(final com.apple.jobjc.appkit.NSImage backgroundImage){
			final com.apple.jobjc.Invoke.MsgSend setImage_IMetInst = get_setImage_IMetInst();

		final com.apple.jobjc.NativeArgumentBuffer nativeBuffer = getRuntime().getThreadLocalState();
		setImage_IMetInst.init(nativeBuffer, this);
		com.apple.jobjc.Coder.IDCoder.INST.push(nativeBuffer, backgroundImage);
