...
public  class NSLock extends com.apple.jobjc.foundation.NSObject {
	public NSLock(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSLock(final NSLock obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
