...
public final class CFStreamClientContext extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		com.apple.jobjc.Coder.UnknownCoder.INST,
		com.apple.jobjc.Coder.UnknownCoder.INST){
		@Override protected CFStreamClientContext newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new CFStreamClientContext(runtime); }
	};

	CFStreamClientContext(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public CFStreamClientContext(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
