...
public  class NSTokenFieldCellClass extends com.apple.jobjc.appkit.NSTextFieldCellClass {
	public NSTokenFieldCellClass(com.apple.jobjc.JObjCRuntime runtime) {
		super(runtime);
	}
	public NSTokenFieldCellClass(String name, com.apple.jobjc.JObjCRuntime runtime) {
		super(name, runtime);
	}
	public NSTokenFieldCellClass(long ptr, com.apple.jobjc.JObjCRuntime runtime) {
		super(ptr, runtime);
	}
