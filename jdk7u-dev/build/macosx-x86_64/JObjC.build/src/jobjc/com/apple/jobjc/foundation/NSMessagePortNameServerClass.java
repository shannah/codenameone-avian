...
public  class NSMessagePortNameServerClass extends com.apple.jobjc.foundation.NSPortNameServerClass {
	public NSMessagePortNameServerClass(com.apple.jobjc.JObjCRuntime runtime) {
		super(runtime);
	}
	public NSMessagePortNameServerClass(String name, com.apple.jobjc.JObjCRuntime runtime) {
		super(name, runtime);
	}
	public NSMessagePortNameServerClass(long ptr, com.apple.jobjc.JObjCRuntime runtime) {
		super(ptr, runtime);
	}
