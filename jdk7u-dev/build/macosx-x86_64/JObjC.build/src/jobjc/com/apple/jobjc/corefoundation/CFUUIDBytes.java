...
public final class CFUUIDBytes extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		com.apple.jobjc.PrimitiveCoder.UCharCoder.INST,
		com.apple.jobjc.PrimitiveCoder.UCharCoder.INST){
		@Override protected CFUUIDBytes newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new CFUUIDBytes(runtime); }
	};

	CFUUIDBytes(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public CFUUIDBytes(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
