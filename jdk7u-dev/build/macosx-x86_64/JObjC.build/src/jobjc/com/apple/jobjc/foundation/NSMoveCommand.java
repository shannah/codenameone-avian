...
public  class NSMoveCommand extends com.apple.jobjc.foundation.NSScriptCommand {
	public NSMoveCommand(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSMoveCommand(final NSMoveCommand obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
