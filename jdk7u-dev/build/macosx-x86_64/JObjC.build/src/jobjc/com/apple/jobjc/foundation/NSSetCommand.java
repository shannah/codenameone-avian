...
public  class NSSetCommand extends com.apple.jobjc.foundation.NSScriptCommand {
	public NSSetCommand(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSSetCommand(final NSSetCommand obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
