...
public  class NSStepperCell extends com.apple.jobjc.appkit.NSActionCell {
	public NSStepperCell(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSStepperCell(final NSStepperCell obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
