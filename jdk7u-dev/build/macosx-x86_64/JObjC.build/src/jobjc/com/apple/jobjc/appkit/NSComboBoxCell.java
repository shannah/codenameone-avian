...
public  class NSComboBoxCell extends com.apple.jobjc.appkit.NSTextFieldCell {
	public NSComboBoxCell(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSComboBoxCell(final NSComboBoxCell obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
	...
	private static com.apple.jobjc.Invoke.MsgSend completedString_IMetInst;
	 final private com.apple.jobjc.Invoke.MsgSend get_completedString_IMetInst(){
		return ((completedString_IMetInst != null)
	? (completedString_IMetInst)
	: (completedString_IMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "completedString:", com.apple.jobjc.Coder.IDCoder.INST, com.apple.jobjc.Coder.IDCoder.INST)));
	}

	 public com.apple.jobjc.foundation.NSString completedString(final com.apple.jobjc.foundation.NSString string){
