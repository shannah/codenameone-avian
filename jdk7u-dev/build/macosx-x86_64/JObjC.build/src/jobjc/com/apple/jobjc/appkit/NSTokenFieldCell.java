...
public  class NSTokenFieldCell extends com.apple.jobjc.appkit.NSTextFieldCell {
	public NSTokenFieldCell(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSTokenFieldCell(final NSTokenFieldCell obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
