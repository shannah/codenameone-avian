...
public  class NSEPSImageRepClass extends com.apple.jobjc.appkit.NSImageRepClass {
	public NSEPSImageRepClass(com.apple.jobjc.JObjCRuntime runtime) {
		super(runtime);
	}
	public NSEPSImageRepClass(String name, com.apple.jobjc.JObjCRuntime runtime) {
		super(name, runtime);
	}
	public NSEPSImageRepClass(long ptr, com.apple.jobjc.JObjCRuntime runtime) {
		super(ptr, runtime);
	}
	...
	: (imageRepWithData_CMetInst = new com.apple.jobjc.Invoke.MsgSend(getRuntime(), "imageRepWithData:", com.apple.jobjc.Coder.IDCoder.INST, com.apple.jobjc.Coder.IDCoder.INST)));
	 ...
	 public <T extends com.apple.jobjc.ID> T imageRepWithData(final com.apple.jobjc.foundation.NSData epsData){
