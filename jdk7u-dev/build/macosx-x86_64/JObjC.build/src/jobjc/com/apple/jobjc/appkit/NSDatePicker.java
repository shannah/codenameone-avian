...
public  class NSDatePicker extends com.apple.jobjc.appkit.NSControl {
	public NSDatePicker(final long objPtr, final com.apple.jobjc.JObjCRuntime runtime) {
		super(objPtr, runtime);
	}
	public NSDatePicker(final NSDatePicker obj, final com.apple.jobjc.JObjCRuntime runtime) {
		super(obj, runtime);
	}
