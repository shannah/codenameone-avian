...
public final class CFXMLNotationInfo extends com.apple.jobjc.Struct {
	...
	private final static com.apple.jobjc.Coder.StructCoder coder = new com.apple.jobjc.Coder.StructCoder(SIZEOF,
		...
		@Override protected CFXMLNotationInfo newInstance(com.apple.jobjc.JObjCRuntime runtime){ return new CFXMLNotationInfo(runtime); }
	};

	CFXMLNotationInfo(final com.apple.jobjc.JObjCRuntime runtime){
		super(runtime, SIZEOF);
	}

	public CFXMLNotationInfo(final com.apple.jobjc.JObjCRuntime runtime, final com.apple.jobjc.NativeBuffer buffer) {
