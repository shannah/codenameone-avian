  ...
  (JNIEnv *env, jclass cls, jint n1, jint n2, jint n3, jint n4, jlong n5, jboolean n6, jint n7, jint n8, jint n9, jstring n10)
{
    ...
    Java_com_codename1_impl_ios_IOSImplementation_editStringAtImpl(n1, n2, n3, n4, (void*)n5, n6, n7, n8, n9, utf, 0);
  ...
  (JNIEnv *env, jclass cls, jstring uri, jobject onCompletion)
{
    ...
    onCompletion = (*env)->NewGlobalRef(env, onCompletion);
    
    dispatch_sync(dispatch_get_main_queue(), ^{
        NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
        [CodenameOne_GLAppDelegate jniEnv]; // to attach thread
    ...
    (*env)->DeleteGlobalRef(env, onCompletion);
  ...
  (JNIEnv *env, jclass cls, jbyteArray b, jobject onCompletion)
{
    ...
    //(*env)->DeleteGlobalRef(env, onCompletion); // Not sure if we need onCompletion to live beyond this method call.
  ...
  (JNIEnv *env, jclass cls, jlong peer, jint w, jint h, jintArray response)
{
    ...
    __block long* data = (*env)->GetIntArrayElements(env, response, 0);
    dispatch_async(dispatch_get_main_queue(), ^{
        NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
...
JNIEXPORT void JNICALL Java_com_codename1_impl_ios_IOSNative_releasePeer
  (JNIEnv *env, jclass cls, jlong peer)
{
    __block NSObject* o = (NSObject*)peer;
    dispatch_sync(dispatch_get_main_queue(), ^{
...
void repaintUI() {
    ...
    jmethodID getInstance = (*env)->GetStaticMethodID(env, Display, "getInstance", "()Lcom/codename1/ui/Display;");
  ...
  (JNIEnv *env, jclass cls, jlong peer)
{
    ...
    dispatch_sync(dispatch_get_main_queue(), ^{
        ...
        returnString = (*env)->NewGlobalRef(env, returnString);
        [pool release];
    });
  ...
  (JNIEnv *env, jclass cls, jlong peer)
{
    ...
    dispatch_sync(dispatch_get_main_queue(), ^{
        ...
        (*env)->NewGlobalRef(env, returnString);
        [pool release];
    });
    return returnString;
}
...
{
	dataObject = (*env)->NewGlobalRef(env, dataObject);
	signed char *data = (*env)->GetByteArrayElements(env, dataObject, 0);
    ...
    (*env)->DeleteGlobalRef(env, dataObject);
    return (jlong)mp;
}
  ...
  (JNIEnv *env, jclass cls, jlong peer, jbyteArray arr)
{
    NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
    NetworkConnectionImpl* impl = (NetworkConnectionImpl*)peer;
    signed char* data = (*env)->GetByteArrayElements(env, arr, 0);
  ...
  (JNIEnv *env, jclass cls, jlong nsData, jbyteArray dataArray)
{
    NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
    NSData* d = (NSData*)nsData;
    signed char *data = (*env)->GetByteArrayElements(env, dataArray, 0);
    memcpy(data, d.bytes, d.length);
    [pool release];
...
void connectionReceivedData(void* peer, NSData* data) {
    ...
    signed char* bytes = (*env)->GetByteArrayElements(env, byteArray, 0);
    [data getBytes: bytes];
...
void pointerPressed(int* x, int* y, int length) {
    ...
    if(length == 1) {
        ...
        (*env)->CallStaticVoidMethod(env, IOSImplementation, pointerPressedCallback, (jint)x[0], (jint)y[0]);
        
    } else {
       jintArray xArray = (*env)->NewIntArray(env, length);
        jintArray yArray = (*env)->NewIntArray(env, length);
        
        long *xarr = (*env)->GetIntArrayElements(env, xArray, 0);
        long *yarr = (*env)->GetIntArrayElements(env, yArray, 0);
...
void pointerDragged(int* x, int* y, int length) {
    ...
    if(length == 1) {
        ...
        (*env)->CallStaticVoidMethod(env, IOSImplementation, pointerDraggedCallback, (jint)x[0], (jint)y[0]);
        ...
        long *xarr = (*env)->GetIntArrayElements(env, xArray, 0);
        long *yarr = (*env)->GetIntArrayElements(env, yArray, 0);
        memcpy(xarr, x, length * sizeof(long));
        memcpy(yarr, y, length * sizeof(long));
        (*env)->ReleaseIntArrayElements(env, xArray, xarr, 0);
        (*env)->ReleaseIntArrayElements(env, yArray, yarr, 0);
...
void pointerReleased(int* x, int* y, int length) {
    ...
    if(length == 1) {
        ...
        (*env)->CallStaticVoidMethod(env, IOSImplementation, pointerReleasedCallback, (jint)x[0], (jint)y[0]);
...
void screenSizeChanged(int width, int height) {
    ...
    (*env)->CallStaticVoidMethod(env, IOSImplementation, sizeChangedImpl, (jint)width, (jint)width);
...
void stringEdit(int finished, int cursorPos, NSString* text) {
    ...
    (*env)->CallStaticVoidMethod(env, IOSImplementation, editingUpdate, fromNSString(env, text), (jint)cursorPos, (jboolean)(finished != 0));
