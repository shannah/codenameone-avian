...
/* Header for class com_codename1_impl_ios_IOSNative */

#ifndef _Included_com_codename1_impl_ios_IOSNative
#define _Included_com_codename1_impl_ios_IOSNative
#ifdef __cplusplus
extern "C" {
#endif
    
    jstring fromNSString(JNIEnv*, NSString*);
    NSString* toNSString(JNIEnv*, jstring);
/*
...
JNIEXPORT void JNICALL Java_com_codename1_impl_ios_IOSNative_editStringAt
  (JNIEnv *, jclass, jint, jint, jint, jint, jlong, jboolean, jint, jint, jint, jstring);
...
JNIEXPORT void JNICALL Java_com_codename1_impl_ios_IOSNative_nativeDrawStringMutable
  (JNIEnv *, jclass, jint, jint, jlong, jstring, jint, jint);
...
JNIEXPORT void JNICALL Java_com_codename1_impl_ios_IOSNative_fillRectRadialGradientGlobal
  (JNIEnv *, jclass, jint, jint, jint, jint, jint, jint, jfloat, jfloat, jfloat);
...
JNIEXPORT jlong JNICALL Java_com_codename1_impl_ios_IOSNative_createImageFile
  (JNIEnv *, jclass, jlong, jboolean, jint, jint, jfloat);
...
JNIEXPORT jlong JNICALL Java_com_codename1_impl_ios_IOSNative_deriveTruetypeFont
  (JNIEnv *, jclass, jlong, jboolean, jboolean, jfloat);
     ...
     * Method:    instanceofObjArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofObjArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofByteArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofByteArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofShortArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofShortArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofLongArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofLongArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofIntArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofIntArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofFloatArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofFloatArrayI
    (JNIEnv *, jclass, jobject);
    
    /*
     * Class:     com_codename1_impl_ios_IOSImplementation
     * Method:    instanceofDoubleArrayI
     * Signature: (Ljava/lang/Object;)Z
     */
    JNIEXPORT jboolean JNICALL Java_com_codename1_impl_ios_IOSImplementation_instanceofDoubleArrayI
    (JNIEnv *, jclass, jobject);
