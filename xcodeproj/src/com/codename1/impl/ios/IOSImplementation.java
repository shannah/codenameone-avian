...
*/
   ...
   // }
     ...
     * Workaround for XMLVM bug
     */
    private static boolean instanceofObjArrayI(Object o){
        return Object[].class.isInstance(o);
    }
    
    /**
     * Workaround for XMLVM bug
     */
    private static boolean instanceofByteArrayI(Object o){
     ...
     * Workaround for XMLVM bug
     */
    private static boolean instanceofShortArrayI(Object o){
        return short[].class.isInstance(o);
    }
    
    /**
     * Workaround for XMLVM bug
     */
    private static boolean instanceofLongArrayI(Object o){
     ...
     * Workaround for XMLVM bug
     */
    private static boolean instanceofIntArrayI(Object o){
     ...
     * Workaround for XMLVM bug
     */
    private static boolean instanceofFloatArrayI(Object o){
     ...
     * Workaround for XMLVM bug
     */
    private static boolean instanceofDoubleArrayI(Object o){
